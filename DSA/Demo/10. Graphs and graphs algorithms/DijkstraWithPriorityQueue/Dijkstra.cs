    ...
    public class Dijkstra
    {
        ...
        public static void Main()
        {
            ...
            var graph = new Dictionary<Node, List<Connection>>
            {
                ...
                { node3, new List<Connection> { new Connection(node4, 6), new Connection(node8, 20), new Connection(node10, 7) } },
                ...
                { node8, new List<Connection> { new Connection(node1, 8), new Connection(node3, 20), new Connection(node10, 30) } },
            ...
            Console.WriteLine(nodes[1].DijkstraDistance);
        }
    }
}
