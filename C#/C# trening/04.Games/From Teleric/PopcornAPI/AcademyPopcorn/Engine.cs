...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        public Engine(IRenderer renderer, IUserInterface userInterface, int sleepTimeInMilliSecond = 500)
        {
            ...
            this.sleepTime = TimeSpan.FromMilliseconds(sleepTimeInMilliSecond);
        }
