...
Bridge се използва, за да разделя абстракцията и имплементацията на две отделни йерархии от класове , така че да може да се променят независимо един от друг. Bridge има почти същата структура като Adapter шаблона. Но той се използва, когато разработваме нови системи, а Adapter се използва във вече съществуващи системи.
