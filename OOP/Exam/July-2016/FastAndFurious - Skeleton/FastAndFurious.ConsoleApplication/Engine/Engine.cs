    ...
    public class Engine
    {
        ...
        {           
            ...
            switch (removeTypeCommand)
            {
                ...
                case GlobalConstants.DriverCommand:
                    {
                        var driver = this.drivers.GetById(objectToAssignId);
                        var raceTrack = this.raceTracks.GetById(ownerToAssignToId);
                        raceTrack.AddParticipant(driver);
                        break;
                    }
                default:
                    {
        ...
        public void ExecuteRemovalStrategy(string[] commandParameters)
        {
            ...
            switch (removeTypeCommand)
            {
                ...
                case GlobalConstants.TunningCommand:
                    {
                        var vehileToRemoveFrom = this.motorVehicles.GetById(ownerToRemoveFromId);
                        var tuningToRemove = this.tunningParts.GetById(objectToRemoveId);
                        vehileToRemoveFrom.RemoveTunning(tuningToRemove);
                        break;
                    }
                default:
                    {
