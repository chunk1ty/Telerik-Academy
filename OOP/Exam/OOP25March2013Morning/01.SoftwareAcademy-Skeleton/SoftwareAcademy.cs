    ...
    public class Teacher : ITeacher
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("teacher name cannot be empty stiring or sequence of white spaces!");
                }
                this.name = value;
            }
        }
    ...
    public abstract class Course : ICourse
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentOutOfRangeException("Course name cannot be empty stiring or sequence of white spaces!");
                }
                this.name = value;
            }
        }
    ...
    public class LocalCourse : Course, ILocalCourse
    {
        ...
        public string Lab
        {
            ...
            set
            {
                ...
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentOutOfRangeException("Local course laboratory cannot be empty stiring or sequence of white spaces!");
                }
                this.lab = value;
            }
        }
    ...
    public class OffsiteCourse : Course, IOffsiteCourse
    {
        ...
        public string Town
        {
            ...
            set
            {
                ...
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentOutOfRangeException("Offsite course town cannot be empty stiring or sequence of white spaces!");
                }
                this.town = value;
            }
        }
